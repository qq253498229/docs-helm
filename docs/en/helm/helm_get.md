...
* [helm get hooks](helm_get_hooks.html)	 - download all hooks for a named release
* [helm get manifest](helm_get_manifest.html)	 - download the manifest for a named release
* [helm get values](helm_get_values.html)	 - download the values file for a named release
