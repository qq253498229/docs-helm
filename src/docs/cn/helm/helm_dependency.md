...
* [helm dependency build](helm_dependency_build.html)	 - rebuild the charts/ directory based on the requirements.lock file
* [helm dependency list](helm_dependency_list.html)	 - list the dependencies for the given chart
* [helm dependency update](helm_dependency_update.html)	 - update charts/ based on the contents of requirements.yaml
